...
export default function ChatArea({
  ...
  setToast,
  toggleSidebar,
  chatId, // IMPORTANT for backend saving
}) {
  ...
  const send = async () => {
    ...
    try {
      await axios.post(
        "http://127.0.0.1:8000/api/chat/add-message",
        {
          chat_id: chatId,
          role: "user",
          text: m,
